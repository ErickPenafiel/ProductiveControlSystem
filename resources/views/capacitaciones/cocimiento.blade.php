...
@section('content_header_subtitle', 'Manuales del area de Cocimiento')

{{-- Content body: main page content --}}

@section('content_body')
    <div class="container-fluid">
        <h1>Manuales de Cocimiento</h1>

        <div class="d-flex justify-content-center align-items-center">
            <div class="row px-5">
                <div class="d-flex bg-white rounded-lg shadow p-3">
                    <div class="img" style="width: 50%;">
                        <img src="{{ asset('storage/images/ManualCocimientos.png') }}" alt="manual-cocimientos"
                            class="img-fluid">
                    </div>

                    <div class="text text-center" style="width: 50%;">
                        <h3>Manual de Cocimiento</h3>
                        ...
                        <a href="{{ route('capacitaciones.pdf', 'ManualOperacionesCoccion.pdf') }}"
